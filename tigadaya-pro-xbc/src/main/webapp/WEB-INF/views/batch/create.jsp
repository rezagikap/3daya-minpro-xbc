		...
		<div class = "row">
			...
			<div class = "form-group">
					...
					<div class = "col-md-10">
						...
						<!-- <input type = "text" class = "form-control" name = "roomId" placeholder = "Trainer"/>-->
					</div>
				</div>
				...
				<div class = "form-group">
					<label class = "control-label col-md-1"></label>
					<div class = "col-md-10">
						<textarea rows="2" class = "form-control" name = "notes" placeholder = "Notes" style="resize:none"></textarea>
					</div>
				</div>
			</div>
		</div>		
