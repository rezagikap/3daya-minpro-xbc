...
<form id="form-create" class="form-horizontal">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						...
						<!--  <input type ="text" class = "form-control" name = "technologyId" placeholder = "Technology Type"/> -->
					</div>
				</div>
				<!-- Period To -->
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label col-md-1"></label>
					<div class="col-md-10">
						<select name="bootcampTypeId" id="bootcampTypeId"
							class="form-control">
	...
	<input type="hidden" class="form-control" name="createdOn"
		id="createdOn" /> <input type="hidden" class="form-control"
